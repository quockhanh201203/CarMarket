...
<body>
    <div class="wrapper">
        <div class="title">Edit Your Vehicle Information</div>
        <form action="/carmarket/editPost" method="post">
            <p style="color: red;">${mess}</p>
            <input type="hidden" id="postId" name="postId" value="${post.postId}" readonly />
            <input type="hidden" id="carId" name="carId" value="${car.carId}" readonly />

            <div class="field">
                <label for="brand">Brand Name<span class="require">*</span></label>
                <select id="brand" name="brand" required>
                    <option value="" disabled selected>${br.brandName}</option>
            ...
            <div class="field">
                ...
                <select id="model" name="model" required>
                    <option value="" disabled selected>${md.modelName}</option>
