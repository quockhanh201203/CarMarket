...
<body>
    <div class="wrapper">
        ...
        <form action="/carmarket/addImage" method="post">
            <p style="color: red;">${mess}</p>
            <div class="field">
                <label for="brandID">Car ID<span class="require">*</span></label>
                <input name="CarID" type="text" value="${carId}" readonly>
            </div>
            <div class="field">
            ...
            <div class="field">
                ...
                <select id="origin" name="origin" required>
                    <option value="" disabled selected>Select car origin</option>
            ...
            <div class="field">
                ...
                <select id="gearbox" name="gearbox" required>
                    <option value="" disabled selected>Select car gearbox</option>
            ...
            <div class="field">
                ...
                <select id="interiorColor" name="interiorColor" required>
                    <option value="" disabled selected>Select car interior color</option>
            ...
            <div class="field">
                ...
                <select id="exteriorColor" name="exteriorColor" required>
                    <option value="" disabled selected>Select car exterior color</option>
    ...
    <script>
        document.getElementById('formattedPrice').addEventListener('input', function(e) {
            ...
            if (value) {
                value = new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(value); // Format as VND
            }
