...
<html>
    ...
    <body>
        <div class="wrapper">
            <div class="title">Edit Car Images</div>
            <form action="/carmarket/doneCreatePost" method="post" enctype="multipart/form-data">
                    ...
                    <div class="post-images">
                        ...
                        <c:forEach var="img" items="${images}">
                            <div style="display: flex; align-items: center;">
                                ...
                                <a href="/carmarket/deleteImage?imageId=${img.imageID}&postId=${postId}" class="delete-button">Delete</a>
                            </div>
                        </c:forEach>
                    </div>
                </c:if>
                ...
                <!-- Button to add another image input -->
