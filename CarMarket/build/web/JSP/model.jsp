...
<body>
            ...
            <nav class="navbar navbar-default bootsnav navbar-sticky navbar-scrollspy" data-minus-value-desktop="70" data-minus-value-mobile="55" data-speed="1000">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="login">carvilla<span></span></a>
                    </div><!--/.navbar-header-->
    ...
    <c:if test="${sessionScope.currentAcc != null && sessionScope.userType != 'client'  && sessionScope.currentAcc.role == 1}">
        <div id="create-model-btn">
            <a href="JSP/insertModel.jsp" class="btn btn-primary">Create Model</a>
        </div>
    </c:if>
    ...
    <section id="featured-cars" class="featured-cars">
        <div class="container">
            ...
            <c:if test="${not empty requestScope.listModel}">
                <div class="row">
                    <c:forEach var="c" items="${requestScope.listModel}">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="featured-cars-content">
                                <div class="single-featured-cars">
                                    <div class="featured-img-box">
                                        <div class="featured-cars-img">
                                            <img src="${c.modelImg}" alt="cars">
                                        </div>
                                    </div>
                                    <div class="featured-cars-txt">
                                        <h2><a href="choosePostByModel?modelID=${c.modelId}">${c.modelName}</a></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
