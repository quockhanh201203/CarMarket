 ...
 * @author admin
 */
@WebServlet(name = "viewCustomerFeedback", urlPatterns = {"/viewCustomerFeedback"})
public class viewCustomerFeedback extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for(Feedback feedback : list){
            ...
            Client client = daoP.getClientByID(userId);
            Clients.add(client);
        }
        
        request.setAttribute("list", list);
        request.setAttribute("Clients", Clients);
        request.getRequestDispatcher("/JSP/listFeedback.jsp").forward(request, response);
    }
