 ...
 * @author admin
 */
@WebServlet(name = "VerifyRegister", urlPatterns = {"/verifyregister"})
public class VerifyRegister extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String check = new MD5().getMd5(e + "muichan123");
        if (check.equals(token)) {
            DAOClient dao = new DAOClient();
            dao.activeAccount(e);
        }
        request.setAttribute("mess", "Your account has been verified. You can log in now!");
